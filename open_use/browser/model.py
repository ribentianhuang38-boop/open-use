"""TypeSafe Jev makes dynamic choices; an optional small text model writes field values."""
...
def action_space(actions: List[Dict[str, Any]]) -> Tuple[List[Dict[str, Any]], Dict[str, Any], Dict[str, Any]]:
...
def choose(state: Dict[str, Any], goal: str, history: List[Dict[str, Any]]) -> Dict[str, Any]:
